...
//        nLastPOWBlock = std::numeric_limits<decltype(nLastPOWBlock)>::max();
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 137); // Testnet vkccoin addresses start with 'x'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet vkccoin script addresses start with '8' or '9'
