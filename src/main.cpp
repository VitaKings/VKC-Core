...
#if defined(NDEBUG)
#error "vkcoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uvkcoin) are considered zero fee (for relaying and mining)
