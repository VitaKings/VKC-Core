 ...
 * vkccoin system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& vkccoinDevKey() const { return vvkccoinDevKey; }
    // const std::vector<unsigned char>& vkccoinFundKey() const { return vvkccoinFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vvkccoinDevKey;
    // std::vector<unsigned char> vvkccoinFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
