...
/** Utility functions used by the vkccoin Qt UI.
 */
namespace GUIUtil
{
...
// Render vkccoin addresses in monospace font
...
// Parse "vkccoin:" URI into recipient object, return true on successful parsing
