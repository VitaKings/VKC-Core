...
This means one can have an always-on vkccoind instance running, and another local vkccoind/vkccoin-qt instance which connects to this node and receives blocks from it.
