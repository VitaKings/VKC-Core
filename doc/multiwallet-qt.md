...
In order to support loading of multiple wallets in vkccoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vkccoin.cpp.
...
Changes to vkccoin.cpp
----------------------
vkccoin.cpp is the entry point into vkccoin-qt, and as such, will require some minor modifications to provide hooks for
