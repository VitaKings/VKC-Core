...
In order to support loading of multiple wallets in vkcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vkcoin.cpp.
...
Changes to vkcoin.cpp
----------------------
vkcoin.cpp is the entry point into vkcoin-qt, and as such, will require some minor modifications to provide hooks for
