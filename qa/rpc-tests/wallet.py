...
#   c) node1 mines 32 blocks, so now node 0 has 60001 vkcoin, node 1 has 4250 vkcoin, node2 has none.
#   d) node0 sends 601 vkcoin to node2, in two transactions (301 vkcoin, then 300 vkcoin).
