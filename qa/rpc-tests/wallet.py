...
#   c) node1 mines 32 blocks, so now node 0 has 60001 vkccoin, node 1 has 4250 vkccoin, node2 has none.
#   d) node0 sends 601 vkccoin to node2, in two transactions (301 vkccoin, then 300 vkccoin).
